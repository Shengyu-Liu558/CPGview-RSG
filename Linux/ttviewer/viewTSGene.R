...
if(len_data == 11){geneData$Exon <- factor(geneData$Exon, levels=c('exon1', 'exon2 (IRa)', 'exon3 (IRa)', 'exon2 (IRb)', 'exon3 (IRb)'))}else if(len_data == 7){geneData$Exon <- factor(geneData$Exon, levels=c('exon1', 'exon2 (IRa)', 'exon2 (IRb)'))}
if(len_data == 11){cddPalette <- c("#808080","#FFFFFF","#FFFFFF","#000000","#000000")}else if(len_data == 7){cddPalette <- c("#808080","#FFFFFF","#000000")}else if(len_data == 5){cddPalette <- c("#000000","#FFFFFF")}
if(len_data == 11){cl <- c("#FFFFFF","#000000","#000000","#000000","#000000","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF")}else if(len_data == 7){cl <- c("#FFFFFF","#000000","#000000","#FFFFFF","#FFFFFF","#FFFFFF","#FFFFFF")}else if(len_data == 5){cl <- c("#FFFFFF","#FFFFFF","#000000","#FFFFFF","#000000")}

if(len_data == 11){pdf(Args[3], width=6.27,height=2.32)}else if(len_data == 7){pdf(Args[3], width=6.27,height=2.32)}else if(len_data == 5){pdf(Args[3], width=6.27,height=2)}
